...
# CHANGE : config was change
# TOCHANGE : maybe to be change
# STOP : enbd of re viewing point
...
#  Default: ''
# CHANGE
c.NotebookApp.password = 'argon2:$argon2id$v=19$m=10240,t=10,p=8$C9HOVnEzo02aO1Lt0CKZTQ$CsqwSloMYM55k3u4vo1rx9E8fSoj1yes9gdak2XZ5g8'
...
#  Choices: any of ['sha512', 'sha3_224', 'blake2s', 'sha3_512', 'sha3_256', 'sha1', 'sha256', 'md5', 'sha384', 'sha224', 'sha3_384', 'blake2b']
#  Default: 'sha256'
